...
const KeysMappingTab = ({ sql1State, sql2State, mappingState, setMappingState, onNext }) => {
    const { log } = useConsole();

    const sourceColumns = sql1State.columns;
    const targetColumns = sql2State.columns;
                ...
                <table className="w-full text-xs">
                    <thead className="bg-slate-100 sticky top-0 z-10">
                        <tr>
                            ...
                            <th className="px-3 py-2 text-left text-brand-900 font-bold">SQL 1 Column</th>
                            <th className="px-3 py-2 text-center w-8"><ArrowRight className="w-3 h-3 mx-auto text-gray-400" /></th>
                            <th className="px-3 py-2 text-left text-brand-500 font-bold">SQL 2 Column</th>
